...
File 8-Byebye betty deletes the file betty.

File 9-Bye bye my first directory deletes the directory my_first_directory that is in the /tmp directory.

File 10-back to the future writes a script that changes the working directory to the previous one.
...
File 18-Life is a series of commas, not periods writes a command that lists all the files and directories of the current directory, separated by commas (,).

File 19- File type: School Create a magic file school.mgc that can be used with the command file to detect School data files. School data files always contain the string SCHOOL at offset 0.
